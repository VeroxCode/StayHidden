...
function useItem(Player)
	...
	Runner = Events.Game.ServerTick.Event:Connect(function(delta)
		...
		Modules.Game:setIProgress(Player.UserId, "Recharging Battery", Progress, 100)

		if (Progress >= 100) then
			Modules.Game:setBattery(MatchPlayer, Modules.Game:getBattery(MatchPlayer) + RefillAmount)
